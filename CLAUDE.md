...
- **Регулярно комітити.** Під час роботи комітити код часто й без окремих прохань — після кожного логічного кроку/завершеної правки, не накопичуючи великі незакомічені зміни. Дрібні, осмислені коміти.
- **Записувати знахідки й граблі.** Все корисне/неочевидне, що дізнався, — одразу дописувати в `docs/ЗНАХІДКИ.md`. Все, на чому спіткнувся (баги, підводні камені, робочі обхідні шляхи), — у `docs/ГРАБЛІ.md`. Один запис = один короткий пункт з датою.
